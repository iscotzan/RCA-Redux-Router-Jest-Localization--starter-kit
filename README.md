...
- React Router v4 fixes for testing.
- Enzyme setup with Adapter.
- actionTypes.js file in common/api for fast and organized creation of actionTypes.
- Language-Selector component added for optional use with the languages support tool. 
- Added different format option for more organized translations with 
